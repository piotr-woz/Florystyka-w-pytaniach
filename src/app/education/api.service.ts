...
export class ApiService {
  ...
  // ****** httpClient version for your YouTube API key ******
  // getPlayListItems(playlistId: string): Observable<PlaylistItemsInterface> {
  ...
  getPlayListItems(playlistId: string): HttpResourceRef<PlaylistItemsInterface> {
    const url = `/api/youtube-proxy?playlistId=${playlistId}`;
    return httpResource<PlaylistItemsInterface>(() => url);
  }
}
